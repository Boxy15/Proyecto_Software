...
class _VistaReportePagosState extends State<VistaReportePagos> {
  ...
  final url = Uri.parse('http://192.168.1.119:3000/api/admin/fechas-corte');
  ...
  Future<void> cargarPagosPorFecha(String fechaCorte) async {
    ...
    final url = Uri.parse('http://192.168.1.119:3000/api/admin/reporte-pagos?fecha_corte=$fechaCorte');
